...
void buildBlueskySegments(vBytes& segment_vec, const vBytes& data_vec) {
    ...
    const std::size_t
        ...
        exif_segment_data_size = encrypted_vec_size > BLUESKY_SEGMENT_LAYOUT.exif_segment_data_size_limit
            ? BLUESKY_SEGMENT_LAYOUT.exif_segment_data_size_limit + segment_vec_data_size
            : encrypted_vec_size + segment_vec_data_size,
        artist_field_size      = exif_segment_data_size - BLUESKY_SEGMENT_LAYOUT.artist_field_size_diff;
