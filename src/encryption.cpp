...
std::uint64_t encryptDataFileCommon(vBytes& segment_vec, vBytes& jpg_vec, vString& platforms_vec,
...
std::uint64_t encryptDataFileFromPathToFile(
    vBytes& segment_vec,
...
std::uint64_t encryptDataFile(vBytes& segment_vec, vBytes& data_vec, vBytes& jpg_vec,
    vString& platforms_vec, const std::string& data_filename, bool hasBlueskyOption, bool hasRedditOption) {
    const std::uint64_t pin = encryptDataFileCommon(
        segment_vec,
        jpg_vec,
        platforms_vec,
        data_filename,
