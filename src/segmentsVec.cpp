...
// If data file too large for exif segment, use the photoshop segment. (exif --> pshop).

std::vector<uint8_t>bluesky_pshop_vec {
	0xFF, 0xED, 0x00, 0x21, 0x50, 0x68, 0x6F, 0x74, 0x6F, 0x73, 0x68, 0x6F,
	0x70, 0x20, 0x33, 0x2E, 0x30, 0x00, 0x38, 0x42, 0x49, 0x4D, 0x04, 0x04,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x05, 0x1C, 0x08, 0x0A, 0x00, 0x00
};

// Any remaining data too large for photoshop segment, we use the xmp segment. (exif --> pshop --> xmp).
