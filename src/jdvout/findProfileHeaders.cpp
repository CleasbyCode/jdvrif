...
void findProfileHeaders(std::vector<uint8_t>&Image_Vec, std::vector<uint_fast32_t>&Profile_Headers_Index_Vec, uint_fast16_t profile_count) {
	...
	uint_fast32_t 
		profile_header_index = 0,
		profile_vec_reserve_size = 1048576;
				   
	Profile_Headers_Index_Vec.reserve(profile_vec_reserve_size);
