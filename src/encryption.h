...
// rather than an APP/EXIF template. Validates it and derives the existing
// secretstream key/header pair from a PIN the caller already collected. Carrier
// positions derive from that PIN, so recovery must obtain it before it can
