...
// Derives the key from the embedded KDF metadata in metadata_vec (prompting
// for the recovery PIN), then streams encrypted_input_path through decrypt
// (and inflate, when is_data_compressed) into stream_output_path.
