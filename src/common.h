...
// Keep the existing decompression-bomb ceiling for the default, Bluesky and
// X-Twitter paths. Reddit accepts larger square images, so its explicitly
// selected conceal/recover carrier may use the platform's 8192x8192 limit.
