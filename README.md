...
There is also a [***jdvrif Web App,***](https://cleasbycode.co.uk/jdvrif/index/) available to use, if you don't want to download & compile the CLI source code.* Web file uploads are limited to 20MB.    
