...
**With ***jdvin***, you can embed a single file of any type upto a maximum size of 1GB.**
**Compatible hosting sites, listed below, have their own (much smaller) image size limits (cover image + data file):**
